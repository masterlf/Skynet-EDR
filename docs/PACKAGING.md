...
SKYNET_EDR_PRODUCT_VERSION=0.6.0-beta.1 \
SKYNET_EDR_DEB_VERSION=0.6.0~beta.1 \
NFPM_ARCH=amd64 \
...
decision: the v0.6.0-beta.1 prerelease does not establish production runtime support,

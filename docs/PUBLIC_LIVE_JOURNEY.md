...
It also pre-creates `/etc/systemd/user/hermes-gateway.service.d` as root-owned
mode 0755. The adapter's directory creation honors the caller's umask; with this

...
Skynet-EDR v0.6.0-rc.1 ships a passive Hermes Agent plugin. The plugin is the preferred
...
rewrite, or delay Hermes actions in v0.6.0-rc.1. Blocking/policy enforcement
...
The v0.6.0-rc.1 plugin registers:
...
That was intentionally out of scope for the historical passive v0.3 and v0.4
milestones and remains out of scope for v0.6.0-rc.1.

...
Skynet-EDR v0.6.0 ships a passive Hermes Agent plugin. The plugin is the preferred
...
rewrite, or delay Hermes actions in v0.6.0. Blocking/policy enforcement
...
milestones and remains out of scope for v0.6.0.

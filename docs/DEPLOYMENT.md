...
sudo /usr/libexec/skynet-edr/deploy-verify --expected-product-version 0.6.0 --expected-deb-version 0.6.0
...
This v0.6.0 stable SemVer evaluation release does not qualify RPM, Arch, non-systemd, multi-host orchestration, database downgrade compatibility, production auto-repair, or Hermes runtime reload/enrollment. Those remain blocked until their own disposable native gates exist.

...
sensor, channel, response action, or deployment mode ships in v0.7.0-alpha.1. The
...
### Passive mode (current v0.7.0-alpha.1)
...
The current v0.7.0-alpha.1 scope remains passive local evidence and read-only

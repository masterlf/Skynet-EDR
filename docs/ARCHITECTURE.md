...
sensor, channel, response action, or deployment mode ships in v0.7.0-alpha.2. The
...
### Passive mode (current v0.7.0-alpha.2)
...
The current v0.7.0-alpha.2 scope remains passive local evidence and read-only

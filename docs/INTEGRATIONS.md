...
This page is the v0.6.0-beta.1 integration index. It points to the runtime-specific docs and states the shared contract all integrations must respect.
...
|---|---|---|---|
| Hermes plugin telemetry | v0.6.0-beta.1 live passive path | Observe Hermes lifecycle hooks, emit canonical JSONL, and write sanitized plugin logs | [Hermes plugin telemetry](HERMES_PLUGIN_TELEMETRY.md) |

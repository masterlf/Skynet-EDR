...
grep_listing "$DIST_DIR/inspection/tarball.txt" '/skynet-edr-hermes-enroll.py$'
grep_listing "$DIST_DIR/inspection/tarball.txt" '/skynet-edr-hermes-enrollment-adapter.py$'
grep_listing "$DIST_DIR/inspection/tarball.txt" '/integrations/hermes/manifest.json$'
...
dpkg-deb --field "$deb" Package Version Architecture Depends \
  > "$DIST_DIR/inspection/deb-fields.txt"
...
grep_listing "$DIST_DIR/inspection/deb.txt" './usr/bin/skynet-edr-hermes-enroll$'
grep_listing "$DIST_DIR/inspection/deb.txt" './usr/libexec/skynet-edr/hermes-enrollment-adapter.py$'
grep_listing "$DIST_DIR/inspection/deb.txt" './usr/libexec/skynet-edr/deploy-verify$'
grep_listing "$DIST_DIR/inspection/deb.txt" './usr/share/skynet-edr/hermes-plugin/manifest.json$'
...
rpm -qplv "$rpm" > "$DIST_DIR/inspection/rpm-verbose.txt"
...
grep_listing "$DIST_DIR/inspection/rpm.txt" '^/usr/bin/skynet-edr-hermes-enroll$'
grep_listing "$DIST_DIR/inspection/rpm.txt" '^/usr/libexec/skynet-edr/hermes-enrollment-adapter.py$'
grep_listing "$DIST_DIR/inspection/rpm.txt" '^/usr/libexec/skynet-edr/deploy-verify$'
grep_listing "$DIST_DIR/inspection/rpm.txt" '^/usr/share/skynet-edr/hermes-plugin/manifest.json$'
...
grep_listing "$DIST_DIR/inspection/archlinux.txt" '^usr/bin/skynet-edr-hermes-enroll$'
grep_listing "$DIST_DIR/inspection/archlinux.txt" '^usr/libexec/skynet-edr/hermes-enrollment-adapter.py$'
grep_listing "$DIST_DIR/inspection/archlinux.txt" '^usr/libexec/skynet-edr/deploy-verify$'
grep_listing "$DIST_DIR/inspection/archlinux.txt" '^usr/share/skynet-edr/hermes-plugin/manifest.json$'

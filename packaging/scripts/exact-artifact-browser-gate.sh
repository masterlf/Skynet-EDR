...
readonly PRODUCT_VERSION="0.7.0-alpha.2"
readonly DEB_VERSION="0.7.0~alpha.2"
...
if value.get('version') != '0.7.0-alpha.2' or value.get('has_api') is not True or tab.get('path') != '/skynet-edr/risks':

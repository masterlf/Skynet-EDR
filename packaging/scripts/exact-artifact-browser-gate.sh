...
readonly PRODUCT_VERSION="0.6.0-beta.1"
readonly DEB_VERSION="0.6.0~beta.1"
...
if value.get('version') != '0.6.0-beta.1' or value.get('has_api') is not True or tab.get('path') != '/skynet-edr/risks':

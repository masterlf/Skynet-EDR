...
- [Current roadmap](docs/ROADMAP.md), [changelog](CHANGELOG.md), and [v0.6.0-beta.1 release notes](docs/releases/v0.6.0-beta.1.md) — shipped scope and remaining limitations.

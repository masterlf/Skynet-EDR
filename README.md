...
- [Current roadmap](docs/ROADMAP.md), [changelog](CHANGELOG.md), and [v0.6.0-alpha.3 release notes](docs/releases/v0.6.0-alpha.3.md) — shipped scope and remaining limitations.

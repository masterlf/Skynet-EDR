...
- [Current roadmap](docs/ROADMAP.md), [changelog](CHANGELOG.md), and [v0.6.0-rc.1 release notes](docs/releases/v0.6.0-rc.1.md) — shipped scope and remaining limitations.

...
- [Current roadmap](docs/ROADMAP.md), [changelog](CHANGELOG.md), and [v0.7.0-alpha.1 release notes](docs/releases/v0.7.0-alpha.1.md) — shipped scope and remaining limitations.
